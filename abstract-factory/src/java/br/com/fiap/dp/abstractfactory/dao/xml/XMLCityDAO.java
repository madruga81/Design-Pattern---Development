...
public class XMLCityDAO implements CityDAO
{
	...
	public Set getCities( )
	{
		...
		try
		{
			parser.parse( XMLHelper.openXMLasBufferedInputStream( ), new ListCitiesContentHandler(
					result ) ) ;
		}
		catch (SAXException se)
		{
	...
	private static class ListCitiesContentHandler extends DefaultHandler
	{
		...
		public void endElement( String uri, String localName, String qName ) throws SAXException
		{
			...
			{
				City city = new City( cityName, new State( cityStateName, new Country(
						cityStateCountryName ) ) ) ;
				result.add( city ) ;
				inCity = false ;
			}
	...
	private static class GetCityContentHandler extends DefaultHandler
	{
		...
		public void endElement( String uri, String localName, String qName ) throws SAXException
		{
			...
			else if ("city".equals( qName ))
			{
				...
				{
					city = new City( cityName, new State( cityStateName, new Country(
							cityStateCountryName ) ) ) ;
				}
				inCity = false ;
			}
